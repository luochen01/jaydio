...
public class DirectRandomAccessFile implements DataInput, DataOutput, Closeable {
    ...
    private static final String UTF8_BOM =
            Character.toString((char) 0xEF) + Character.toString((char) 0xBB) + Character.toString((char) 0xBF);
     ...
     *
     * @param mode
     *            Either "rw" or "r", depending on whether this file is read only
     *
     * @throws IOException
     */
     ...
     *
     * @param bufferSize
     *            The size of the buffer used to manually buffer I/O
    ...
    public DirectRandomAccessFile(File file, String mode, int bufferSize) throws IOException {
        ...
        this.channel = bufferSize != -1 ? DirectIoByteChannelAligner.open(file, bufferSize, readOnly)
     ...
     *
     * @param offset
     *            The offset within dst to start reading
     *
     * @param length
